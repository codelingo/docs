# Flows
Flows automate common developer and sysadmin tasks by chaining together a pipeline of Bots. Each Flow has it's own dashboard with panels generated by the Bots in it.
